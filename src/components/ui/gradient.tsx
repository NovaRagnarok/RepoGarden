// Vendored from termcn @ shadcn-labs/termcn registry/bases/ink/ui/gradient.tsx
// (commit on main as of 2026-05). Keep API and presets identical to upstream
// so future updates can be re-pulled wholesale.
